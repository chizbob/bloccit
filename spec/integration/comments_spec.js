...
describe("routes : comments", () => {
  ...
  //End member trying to delete member content

  //Admin trying to delete others comment
  describe("admin performing CRUD actions for others Comment", () => {
    ...
    describe("POST /topics/:topicId/posts/:postId/comments/create", () => {
      ...
      it("should create new comment and redirect", (done) => {
        const options = {
          url: `${base}${this.topic.id}/posts/${this.post.id}/comments/create`,
          form: {
            body: "This comment is amazing!"
    ...
    describe("POST /topics/:topicId/posts/:postId/comments/:id/destroy", () => {
      ...
      it("should delete others comment", (done) => {
        Comment.all()
        .then((comments) => {
          const commentCountBeforeDelete = comments.length;
          expect(commentCountBeforeDelete).toBe(1);
  ...
  }); //End admin trying to delete others comment
